...
public class Api {
	...
	public JSONObject analyze(String content) {
		/* 如果是循环调用下面举例的接口，需要从此处开始你的循环语句。切记！ */
		TreeMap<String, Object> config = new TreeMap<String, Object>();
		config.put("SecretId", "AKID41mT488mJenpeQnYvStFTgicLwLZElkX");
		config.put("SecretKey", "vgGyOmyzqWQExWu5771jIftvqfJ5qU0D");
		/* 请求方法类型 POST、GET */
		config.put("RequestMethod", "GET");
		/* 区域参数，可选: gz:广州; sh:上海; hk:香港; ca:北美;等。 */
		config.put("DefaultRegion", "qd");
	...
	public JSONObject analyze(String text, int code, int type) {
		/* 如果是循环调用下面举例的接口，需要从此处开始你的循环语句。切记！ */
		TreeMap<String, Object> config = new TreeMap<String, Object>();
		config.put("SecretId", "AKID41mT488mJenpeQnYvStFTgicLwLZElkX");
		config.put("SecretKey", "vgGyOmyzqWQExWu5771jIftvqfJ5qU0D");
